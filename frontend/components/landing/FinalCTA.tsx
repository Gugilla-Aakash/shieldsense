...
export default function FinalCTA() {
  return (
    <section className="relative isolate flex min-h-[820px] items-center justify-center overflow-hidden bg-bg-base py-32 sm:py-40 lg:min-h-[900px] lg:py-48">
      {/* =====================================================
          DEEP ATMOSPHERE
         ===================================================== */}
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 flex h-[780px] w-[780px] -translate-x-1/2 -translate-y-1/2 items-center justify-center">
        ...
        <motion.div
          ...
          className="absolute h-[76%] w-[76%] rounded-full border border-blue-400/[0.08] border-dashed"
        >
      ...
      >
        ...
        {/* Description */}
        <p className="mt-9 max-w-2xl text-base leading-8 text-text-secondary sm:text-lg">
        ...
        {/* Trust signals */}
        <div className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-[9px] font-bold uppercase tracking-[0.18em] text-text-muted">
